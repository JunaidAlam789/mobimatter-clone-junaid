...
export const ToggleButton = () => {
  ...
  return (
    ...
    <div className=' absolute flex justify-end  md:text-xl font-semibold -top-10 -right-3 sm:-top-12 sm:-right-7 md:-top-12 md:-right-7 lg:-top-12 lg:right-0 xl:-top-14 xl:right-10 2xl:-top-14 2xl:right-10  3xl:-top-14 3xl:right-10'>
