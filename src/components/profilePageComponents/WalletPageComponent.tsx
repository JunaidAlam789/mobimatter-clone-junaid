...
const WalletPageComponent = () => {
  return (
      <div className='pt-6'>
        ...
        <p className='py-2'>* Rewards credits can be used to get eSIMs and top-ups for free! To claim your free gift, collect at least $15 in rewards credits and enough to cover the cost of the product.<span className='underline text-btnblue'>Terms and conditions </span> apply.</p>
        ...
        <div className='py-4 space-y-2'>
            ...
            <div className='flex  space-x-1 text-txtgrey'>
                <Info/>
                <p className='text-lg text-wrap'>The code should be entered during checkout when prompted.</p>
            </div>
        </div>
      </div>
