  ...
  return (
    <div className=' flex flex-col items-center justify-center w-full mt-20 space-y-5 '>
        ...
        <div className=" flex flex-col items-center justify-center space-y-5 w-[234px]  ">
            <Button className=' bg-white text-black hover:bg-white hover:opacity-70 shadow-md space-x-3 w-[234px]' >
            ...
            <Button className=' bg-[#c71610] text-white w-[234px] hover:bg-[#c71610] hover:opacity-70 shadow-md space-x-3' >
             ...
             {/* Text */}
        <p className=' text-center'>By continuing, you are indicating that you accpet our <span className=" text-btnblue">Terms of Service</span> and <span className=" text-btnblue">Privacy Policy</span></p>
        </div>
