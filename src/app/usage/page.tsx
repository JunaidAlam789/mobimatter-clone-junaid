  ...
  return (
    <div className='min-h-[70vh] min-w-screen lg:mx-[7rem] lg:px-[1.5rem] px-[0.5rem] flex flex-col items-center pt-10 space-y-4'>
      <div className='w-full'>
        <h2 className='text-[1.8rem] fontsemi-bold'>eSIM Status and Usage Check</h2>
      ...
      <div className='w-full'>
        ...
        <div className='flex flex-col sm:flex-row  w-full sm:space-x-2 space-y-2 sm:space-y-0'>
          <input className='w-full rounded-md border-2 border-btnblue outline-none px-6 focus:shadow-sm py-2 focus:shadow-btnblue' placeholder='MM-12345'/>
