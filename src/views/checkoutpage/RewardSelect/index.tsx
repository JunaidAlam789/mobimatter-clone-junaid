...
export const RewardSelect = () => {
  return (
    <>
      ...
      {/* Referral Cards */}
      <div className=" flex flex-col min-[711px]:flex-row items-center gap-x-3 gap-y-5 mt-4 ">
        {/* First Card */}
        <div className=" bg-white p-6 shadow-md rounded-md w-full min-[711px]:max-w-[283px] text-center">
